...
public class MetricsRepositoryUtils {
  ...
  public static VeniceMetricsRepository createSingleThreadedMetricsRepositoryNew() {
    return createSingleThreadedMetricsRepositoryNew(TimeUnit.MINUTES.toMillis(1), 100);
  }
